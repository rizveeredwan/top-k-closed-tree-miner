...
class PatternExtensionLinkedList:
    ...
    def __init__(self, node, level, projection_status=None):
        self.node = node
        self.level = level
        self.prev_link = None
        self.next_link = None
        self.projection_status = projection_status # None: initial, 0: intermediate projection, 1: complete projection
        ...
        for i in range(0, len(updated_cspm_tree_nodes)):
            if i == 0:
                ...
                self.value_update(ll_node=current_node, cspm_tree_node=updated_cspm_tree_nodes[i],
                                  level=old_level + 1)
                current_node.projection_status = 0 # intermediate
            else:
...
class PatternTrie:
    ...
    def __init__(self):
        ...
        self.projection_status = None # [0: intermediate processing, 1: processed]
        self.child = None
        self.s_ex = None
        self.i_ex = None
    ...
    def update_attributes(self, new_node, cspm_tree_nodes=None, cspm_tree_node_bitset=None, projection_status=None, s_ex=None, i_ex=None,
        ...
        new_node.projection_status = projection_status
        if s_ex is not None:
            new_node.s_ex = s_ex
        if i_ex is not None:
            new_node.i_ex = i_ex
    ...
    def insert(self, root, pattern, current_end, cspm_tree_nodes=None, projection_status=None, cspm_tree_node_bitset=None, s_ex=None, i_ex=None,
               flag=None, work_with_sex=None):
        ...
        self.update_attributes(new_node=new_node, cspm_tree_nodes=cspm_tree_nodes,
                               ...
                               projection_status=projection_status, s_ex=s_ex, i_ex=i_ex, flag=flag,
    ...
    def clear_all_the_attributes(self, current):
        ...
        current.projection_status = None
        current.s_ex = None
        current.i_ex = None
    ...
    def extract_cspm_tree_nodes(self, trie_node, NODE_MAPPER=None):
        ...
        if trie_node is not None and trie_node.cspm_tree_nodes is not None:
            ...
            return trie_node.cspm_tree_nodes, trie_node.projection_status
            ...
            return cspm_tree_nodes, trie_node.projection_status
...
class CapheNode:
    ...
    def insert_pattern(self, caphe_node, pattern, cspm_tree_nodes, cspm_tree_node_bitset, projection_status, s_ex, i_ex, flag=None,
                       work_with_sex=True):
